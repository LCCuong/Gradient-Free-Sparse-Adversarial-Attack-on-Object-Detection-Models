...
if __name__ == '__main__':
    ...
    parser.add_argument("--perturbation_range", type=float, default=1.0)
    parser.add_argument("--tournament_size", type=int, default=4)
    parser.add_argument("--max_archive_size", type=int, default=800)
    ...
    assert args.model_name in model_name.keys()
    assert args.early_stop == 0 or args.early_stop == 1

    yolo = YOLO(model_name[args.model_name])
